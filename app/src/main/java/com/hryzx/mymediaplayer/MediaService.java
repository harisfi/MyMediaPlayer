...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "com.hryzx.mymediaplayer.mediaservice.create";
    public final static String ACTION_DESTROY = "com.hryzx.mymediaplayer.mediaservice.destroy";
    ...
    private void init() {
        ...
        AssetFileDescriptor afd = getApplicationContext().getResources().openRawResourceFd(R.raw.under_the_moon);
        try {
